...
def hourmap(data,
            bans = {"2020-04-20":'Groups >100 banned',
                    "2020-05-01":'Groups >5 banned'},
            ax=None,
            scale = 1e9):
    """
...
def plot(displacement_RMS,
         ...
         bans = {"2020-03-12":'Groups >5 banned',
                 "2020-03-20":'Groups >100 banned'},
         type = '*',
         scale = 1e9,
